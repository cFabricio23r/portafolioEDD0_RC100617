...
int main(){
    ...
    cout << "Tamano de la lista: " << miLista.tamanio() << endl << endl;
    ...
    cout << "Tamano de la lista: " << miListaDouble.tamanio() << endl << endl;
    ...
    cout << "Las lista es: " << miListaDouble.comoCadena() << endl << endl;
